...
![The scene view showing the character with a Character Controller capsule around the model](images/properties-controller.png){:width="200px"}
...
![The Project Window with new My Scripts folder shown.](images/my-scripts-folder.png){:width="300px"}
...
![The Project window with new PlayerController script shown.](images/PlayerController-script.png){:width="200px"}
...
![The tab for the Console window highlighted in the bottom left section of the Unity editor.](images/console-window.png){:width="200px"}
...
![The Toolbar at the top of the Unity Editor with Play button highlighted.](images/play-button.png){:width="200px"}
...
![The colour wheel pop up window with a blue medium opacity tint selected.](images/tint-colour-window.png){:width="300px"}
...
![Scene and game view of character up against the wall.](images/player-wall.gif){:width="300px"}
...
![Move Speed set to 3 and Rotate Speed set to 1 in the Inspector](images/inspector-variables.png){:width="200px"}
